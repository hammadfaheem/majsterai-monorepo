...
from .interfaces.membership_unavailability.router import router as membership_unavailability_router
...
from .interfaces.org_notification_recipient.router import router as org_notification_recipient_router
...
# CORS middleware - allow all origins for dev; set CORS_ORIGINS in .env to restrict
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
app.include_router(membership_unavailability_router, prefix="/api/membership-unavailability", tags=["membership-unavailability"])
...
app.include_router(trade_category_router, prefix="/api/trade-categories", tags=["trade-categories"])
app.include_router(trade_service_router, prefix="/api/trade-services", tags=["trade-services"])
...
app.include_router(notification_type_router, prefix="/api/notification-types", tags=["notification-types"])
app.include_router(notification_log_router, prefix="/api/notification-logs", tags=["notification-logs"])
app.include_router(org_notification_recipient_router, prefix="/api/org-notification-recipients", tags=["org-notification-recipients"])
